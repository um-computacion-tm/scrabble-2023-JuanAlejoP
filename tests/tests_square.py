...
class TestSquare(unittest.TestCase):
    def test_init(self):
        ...
        self.assertEqual(square.multiplier_type, 'letter')
        self.assertIsNone(square.letter)
        self.assertEqual(
            square.calculate_value(), 0
        )
    ...
    def test_square_value(self):
        ...
        self.assertEqual(
            square.calculate_value(), 6
            )
    
    def test_square_multiplier_word(self):
        square= Square(multiplier = 2, multiplier_type= 'word')
        letter= Tile('P', 3)
        square.add_letter(letter)
        self.assertEqual(
            square.calculate_value(), 3
        )
